...
def get_model_token_limit(model: ModelType) -> int:
    ...
    if model == ModelType.GPT_3_5_TURBO:
        ...
        return 128000
    elif model == ModelType.GPT_4_O_MINI:
        return 128000
    elif model == ModelType.GPT_4_O_MINI_NEW:
        return 128000
    elif model == ModelType.GPT_4_1_MINI:
        return 128000
    elif model == ModelType.GPT_4_1_MINI_NEW:
        return 128000
    # Google Models
    elif model == ModelType.GLM_4_5_AIR:
        return 128000
    elif model == ModelType.GEMINI_3_PRO_SEARCH:
        return 1000000
    elif model == ModelType.GEMINI_3_PRO_THINKING:
        return 1000000
    elif model == ModelType.GEMINI_EMBEDDING_001:
        return 2048
    elif model == ModelType.GEMINI_FLASH_SEARCH:
        return 1000000
    # Anthropic Models
    elif model == ModelType.CLAUDE_HAIKU_4_5:
        return 200000
